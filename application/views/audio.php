<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Audio Management
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>audio/addNew"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>audio" method="POST" id="searchList">
                    ...
                    <tr>
                        ...
                        <?php if($role == ROLE_ADMIN){ ?>
                            <td>
                                <?php
                                if($audio->status == 2){    ?>
                                    <a class="btn btn-success" href="<?php echo base_url(); ?>audio/approve/<?php echo $audio->id ?>">
                                        Approve
                                    </a>
                                    <a class="btn btn-danger" href="<?php echo base_url(); ?>audio/decline/<?php echo $audio->id ?>">
                                        Decline
                                    </a>
                                <?php } 
                                if($audio->status == 1){    ?>

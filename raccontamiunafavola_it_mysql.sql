...
--
-- Host: raccontamiunafavola.it.mysql:3306
-- Generation Time: Jan 26, 2019 at 03:46 PM
...
--
-- Database: `raccontamiunafavola_it_alexa_story`
--
CREATE DATABASE `raccontamiunafavola_it_alexa_story` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `raccontamiunafavola_it_alexa_story`;
...
INSERT INTO `tbl_audio` (`id`, `user_id`, `file`, `category_id`, `description`, `status`, `created_at`) VALUES
(7, 26, '/uploads/file_example_MP3_1MG2.mp3', 8, 'Testttttt', 0, '2019-01-12 09:02:26'),
(6, 26, '/uploads/file_example_MP3_1MG1.mp3', 8, 'Testttttt', 1, '2019-01-13 08:15:37');
...
INSERT INTO `tbl_authors` (`authorid`, `user_id`, `name`, `nick_name`, `gender`, `image`, `roleId`, `isDeleted`, `createdBy`, `createdDtm`, `updatedBy`, `created_at`) VALUES
(1, 0, 'testt', 'test nick', 'female', '', 0, 0, 0, '0000-00-00 00:00:00', NULL, NULL),
(2, 0, 'testt123', 'test nick1234', 'female', '', 0, 0, 0, '0000-00-00 00:00:00', NULL, NULL),
(3, 30, 'Test21', 'Test21', 'Male', '', 0, 0, 0, '0000-00-00 00:00:00', NULL, '2019-01-24 06:08:28'),
(4, 27, 'Khv', 'Ufk', 'Male', '', 0, 0, 0, '0000-00-00 00:00:00', NULL, '2019-01-24 06:27:16'),
(5, 27, 'Ssds', 'Sdsd', 'Male', '', 0, 0, 0, '0000-00-00 00:00:00', NULL, '2019-01-24 06:34:11');
...
CREATE TABLE IF NOT EXISTS `tbl_kind` (
...
INSERT INTO `tbl_kind` (`kindid`, `kind_name`, `notes`, `updatedDtm`) VALUES
(4, 'Test', 'testttt', '2019-01-25 18:15:21');
...
INSERT INTO `tbl_stories` (`id`, `user_id`, `file`, `description`, `title_id`, `author_id`, `reader_id`, `length`, `kindid`, `style_id`, `status`, `image`, `isDeleted`, `createdBy`, `createdDtm`, `updatedBy`, `created_at`) VALUES
(1, 1, '/uploads/file_example_MP3_1MG3.mp3', 'Testtttt', 9, 1, 0, '', 0, 0, 2, '', 0, 0, '0000-00-00 00:00:00', 0, '2019-01-24 06:08:00'),
(2, 1, '/uploads/file_example_MP3_1MG4.mp3', 'Asasas', 11, 1, 0, '', 0, 0, 2, '', 0, 0, '0000-00-00 00:00:00', 0, '2019-01-24 06:14:29'),
(3, 27, '/uploads/file_example_MP3_1MG5.mp3', 'Ln', 9, 27, 0, '', 0, 0, 2, '', 0, 0, '0000-00-00 00:00:00', 0, '2019-01-24 06:29:36'),
(4, 1, '/uploads/file_example_MP3_1MG6.mp3', 'Testt', 9, 2, 0, '1062.35', 4, 0, 2, '', 0, 0, '0000-00-00 00:00:00', 0, '2019-01-25 06:15:53'),
(5, 31, '/uploads/file_example_MP3_1MG7.mp3', 'Ds', 13, 1, 0, '1062.35', 4, 0, 1, '', 0, 0, '0000-00-00 00:00:00', 0, '2019-01-26 13:49:58');
...
INSERT INTO `tbl_title` (`id`, `name`) VALUES
(9, 'Random'),
(8, 'Cenerentola'),
(11, 'Kishan'),
(12, 'Test123'),
...
(1, 'superadmin@raccontamiunafavola.it', '$2y$10$6NOKhXKiR2SAgpFF2WpCkuRgYKlSqFJaqM0NgIM3PT1gKHEM5/SM6', 'System Administrator', '', '', '23', 1, 0, 0, 0, '2015-07-01 18:56:49', 1, '2018-01-05 05:56:34'),
